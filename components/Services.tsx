    ...
    <section className="py-24 relative" id="services">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold mb-6 font-display">Des services complets pour <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-orange-400">votre infrastructure web</span></h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="h-full bg-[#150528]/50 border-white/10 group">
              <div className="mb-6 p-4 rounded-2xl bg-gradient-to-br from-fuchsia-500/10 to-purple-500/10 w-fit group-hover:from-fuchsia-500/20 group-hover:to-orange-500/20 transition-colors border border-white/5">
                <service.icon className="w-8 h-8 text-fuchsia-400 group-hover:text-orange-400 transition-colors" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-white group-hover:text-fuchsia-200 transition-colors">{service.title}</h3>
              <p className="text-gray-400 leading-relaxed mb-6 group-hover:text-gray-300 transition-colors">
                {service.description}
              </p>
              <a href="#" className="inline-flex items-center text-sm font-semibold text-fuchsia-400 hover:text-orange-400 transition-colors uppercase tracking-wider">
