...
export const Team: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-[#090014] relative overflow-hidden" id="team">
      {/* Background Glows */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold font-display mb-4">Notre <span className="text-fuchsia-400">Équipe Technique</span></h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {teamMembers.map((member, idx) => (
            <Card key={idx} className="group text-center bg-[#150528]/80 border-white/5 hover:border-fuchsia-500/30">
              <div className="relative w-32 h-32 mx-auto mb-6">
                ...
                <img 
                  ...
                  className="w-full h-full object-cover rounded-full relative z-10 border-2 border-[#150528] bg-[#150528]" 
                />
              </div>
              <h3 className="text-xl font-bold text-white mb-1 font-display">{member.name}</h3>
              <p className="text-fuchsia-400 text-sm font-medium mb-4 uppercase tracking-wider">{member.role}</p>
