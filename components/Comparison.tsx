  ...
  return (
    <section className="py-24 container mx-auto px-6 relative">
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Dev Column */}
        <Card className="bg-gradient-to-br from-[#150528] to-[#0d0420] border-fuchsia-500/20 shadow-[0_0_30px_rgba(217,70,239,0.05)]">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-fuchsia-500/20 rounded-xl text-fuchsia-400 shadow-[0_0_15px_rgba(217,70,239,0.2)]">
              <Code className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold font-display">Développement Sur Mesure</h3>
          </div>
        ...
        {/* Security Column */}
        <Card className="bg-gradient-to-br from-[#150528] to-[#0d0420] border-orange-500/20 shadow-[0_0_30px_rgba(249,115,22,0.05)]">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-orange-500/20 rounded-xl text-orange-400 shadow-[0_0_15px_rgba(249,115,22,0.2)]">
              <ShieldCheck className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold font-display">Maintenance & Sécurité</h3>
          </div>
          <p className="text-gray-400 mb-8 min-h-[60px]">
