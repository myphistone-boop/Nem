        ...
        <div className="lg:col-span-5 flex flex-col gap-8 text-center lg:text-left">
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
            ...
            <p className="text-sm text-textMuted">
              <span className="font-bold text-textMain">100%</span> sécurisé & maintenu
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 relative h-[600px] w-full hidden lg:block perspective-[1000px]">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[460px] h-[340px] z-20 animate-float-slow rotate-y-6 rotate-x-6">
            <Card className="h-full bg-surface/90 border-fuchsia-500/30 shadow-[0_0_50px_rgba(217,70,239,0.15)] backdrop-blur-xl">
              <div className="flex justify-between items-center mb-6 border-b border-white/5 pb-4">
                <div>
                  <h3 className="text-xs text-fuchsia-400 uppercase tracking-widest font-bold">État du Système</h3>
                  <div className="flex items-baseline gap-2">
                    <p className="text-3xl font-display font-bold text-textMain mt-1 shadow-black drop-shadow-md">Opérationnel</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 mt-4">
                 <div className="space-y-2">
                    <div className="flex justify-between text-xs text-textMuted">
                        ...
                        <span className="text-textMain">98%</span>
                    </div>
                 ...
                 <div className="space-y-2">
                    <div className="flex justify-between text-xs text-textMuted">
                        ...
                        <span className="text-textMain">Actif</span>
                    </div>
                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                 ...
                 <div className="space-y-2">
                    <div className="flex justify-between text-xs text-textMuted">
                        ...
                        <span className="text-textMain">100%</span>
                    </div>
                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
              ...
              <div className="mt-6 flex justify-between items-center text-xs text-textMuted font-mono">
                ...
                <span className="flex items-center gap-1 text-green-500"><Lock className="w-3 h-3"/> Sécurisé</span>
              </div>
            </Card>
          </div>
          ...
          <div className="absolute top-24 -right-4 z-30 animate-float-medium">
            <div className="glass-panel p-4 rounded-2xl flex items-center gap-4 border-l-4 border-l-orange-500 bg-surface/90 backdrop-blur-md shadow-[0_0_30px_rgba(249,115,22,0.2)]">
              ...
              <div>
                <p className="text-xs text-textMuted uppercase tracking-wide">Menaces bloquées</p>
                <p className="text-xl font-bold text-textMain">142</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-20 left-4 z-30 animate-float-fast">
            <div className="glass-panel p-4 rounded-2xl flex items-center gap-4 border-l-4 border-l-cyan-400 bg-surface/90 backdrop-blur-md shadow-[0_0_30px_rgba(34,211,238,0.2)]">
              ...
              <div>
                <p className="text-xs text-textMuted uppercase tracking-wide">Vitesse de chargement</p>
